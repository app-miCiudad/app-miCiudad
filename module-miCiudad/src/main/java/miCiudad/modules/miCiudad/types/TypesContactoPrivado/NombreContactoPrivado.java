...
@Property(maxLength = NombreContactoPrivado.MAX_LEN, mustSatisfy = NombreContactoPrivado.Spec.class,editing = Editing.ENABLED)
@Parameter(maxLength = NombreContactoPrivado.MAX_LEN, mustSatisfy = NombreContactoPrivado.Spec.class)
@ParameterLayout(named = "Nombre")
@Target({ ElementType.METHOD, ElementType.FIELD, ElementType.PARAMETER, ElementType.ANNOTATION_TYPE })
@Retention(RetentionPolicy.RUNTIME)
public @interface NombreContactoPrivado {
