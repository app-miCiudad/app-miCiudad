...
public class Barrio_addObra {
    ...
    public Barrio act(
            @TituloObra final String titulo, @EspecificacionObra final String esp,
            ...
            @TyEstadoObra final String estado, @FotoObra final String foto, @PorcentajeAvanceObra final String porcentajeAvance
            ) {
        repositoryService.persist(new Obra(barrio,titulo,esp,fechaInicio,fechaFinal, presupuesto,
        latitud,longitud,tipo,estado,foto, porcentajeAvance));
        return barrio;
    }
    /////////////////////////////////////////////
