...
import miCiudad.modules.obras.types.EmailAddress;
import miCiudad.modules.obras.types.FirstName;
import miCiudad.modules.obras.types.LastName;
import miCiudad.modules.obras.types.Notes;
import miCiudad.modules.obras.types.PhoneNumber;
...
@DomainObject(logicalTypeName = "obras.Barrio", entityChangePublishing = Publishing.ENABLED)
@DomainObjectLayout()
