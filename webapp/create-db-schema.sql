...
CREATE TABLE miCiudad.OBRA (id BIGINT NOT NULL, especificacion VARCHAR(4000) NOT NULL, fechaFinal BYTEA, fechaInicio BYTEA, presupuesto FLOAT, titulo VARCHAR(40) NOT NULL, barrio_id BIGINT, PRIMARY KEY (id))
