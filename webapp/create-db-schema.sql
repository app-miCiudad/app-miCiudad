...
CREATE TABLE miCiudad.OBRA (id BIGINT NOT NULL, especificacion VARCHAR(4000) NOT NULL, fechaFinal BYTEA, fechaInicio BYTEA, latitud FLOAT NOT NULL, longitud FLOAT NOT NULL, presupuesto FLOAT, tipo VARCHAR(255) NOT NULL, titulo VARCHAR(40) NOT NULL, barrio_id BIGINT, PRIMARY KEY (id))
