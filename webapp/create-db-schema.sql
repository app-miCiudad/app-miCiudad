...
CREATE TABLE miCiudad.OBRA (id BIGINT NOT NULL, especificacion VARCHAR(4000) NOT NULL, TyEstadoObra VARCHAR(20) NOT NULL, fechaFinal VARCHAR(255), fechaInicio VARCHAR(255), idEmpresa VARCHAR(4000), latitud VARCHAR(255) NOT NULL, longitud VARCHAR(255) NOT NULL, presupuesto VARCHAR(255), tipo VARCHAR(255) NOT NULL, titulo VARCHAR(40) NOT NULL, barrio_id BIGINT, empresa_id BIGINT, PRIMARY KEY (id))
